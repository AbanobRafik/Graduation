...
- **Response**:
    ```json
    ["math.json", "science.json"]
    ```
    **Description**: This endpoint returns all subjects (as .json files) for the specified grade and term.
...
- **Request**:
    ```bash
    GET /api/fourthGrade/firstTerm/math.json/units
    ```
- **Response**:
    ```json
    ["unit1", "unit2", "unit3"]
